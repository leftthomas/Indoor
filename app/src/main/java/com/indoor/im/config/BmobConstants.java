...
public class BmobConstants {
     ...
     * 存放发送图片的目录
     */
    public static String BMOB_PICTURE_PATH = Environment.getExternalStorageDirectory() + "/indoorim/image/";
    /**
     * 我的头像保存目录
     */
    public static String MyAvatarDir = "/sdcard/indoorim/avatar/";
}
